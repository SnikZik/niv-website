...
METAS={
 "pritzat-dlatot":["פריצת דלתות ב{A} 24/7. ניב מגיע תוך {E}, פותח בזהירות בלי נזק, מחיר סגור בטלפון מ-350₪. חייגו 050-8307269 עכשיו.",
 "ננעלתם ב{A}? פריצת דלת מקצועית תוך {E}, בלי נזק לדלת ובלי הפתעות במחיר. מ-350₪, סגור מראש בטלפון. חייגו 050-8307269.",
 "פריצת דלתות ב{A} עם מנעולן מקומי. הגעה תוך {E} ביום ובלילה, פתיחה עדינה ומחיר שנסגר בשיחה מ-350₪. חייגו 050-8307269."],
 "tzilinder":["החלפת צילינדר ב{A} תוך {E}. התאמת צילינדר רגיל או מוגן, עבודה נקייה ומחיר סגור בטלפון מ-350₪. חייגו 050-8307269.",
 "צריכים החלפת צילינדר ב{A}? ניב מגיע תוך {E} עם מבחר צילינדרים, מרכיב ומוסר מפתחות. מ-350₪ סגור מראש. חייגו 050-8307269.",
 "החלפת צילינדר ב{A}, גם באותו יום. צילינדר מוגן או רגיל לכל דלת, מחיר בטלפון מ-350₪ בלי תוספות. חייגו 050-8307269."],
 ...
 "manul-hacham":["התקנת מנעול חכם ב{A} מ-2,200₪ כולל התקנה והדרכה. קוד, טביעת אצבע או אפליקציה. תיאום מהיר, ניב 050-8307269.",
 "מנעול חכם ב{A}? התאמה לדלת שלכם, התקנה מקצועית והדרכה מלאה, מ-2,200₪ הכל כלול. חייגו 050-8307269 לפרטים.",
 "רוצים להיכנס הביתה ב{A} בלי מפתח? מנעול חכם מותקן ומוגדר מ-2,200₪, כולל גיבוי לכל תרחיש. ניב 050-8307269."],
 "mafteah-shavur":["מפתח נשבר במנעול ב{A}? חילוץ עדין תוך {E} בלי נזק לצילינדר, מ-350₪ סגור בטלפון. חייגו 050-8307269 לניב.",
 "חילוץ מפתח שבור ב{A} ביום ובלילה. ניב מגיע תוך {E} עם כלים ייעודיים, המחיר נסגר בשיחה מ-350₪. חייגו 050-8307269.",
 "נשאר לכם חצי מפתח ביד ב{A}? חילוץ מקצועי מהצילינדר תוך {E}, מ-350₪ בלי הפתעות. חייגו 050-8307269."],
 "ksafot":["פריצת כספות ב{A} בלי נזק לתכולה. הגעה תוך {E}, מחיר לפי סוג הכספת נסגר בטלפון. כספת חדשה מ-550₪. ניב 050-8307269.",
 "כספת לא נפתחת ב{A}? קוד שנשכח או סוללה שמתה, ניב פותח בזהירות תוך {E}. מחיר סגור בשיחה. חייגו 050-8307269.",
 "פריצת כספת ב{A} עם מנעולן מקומי. פתיחה עדינה, אספקת כספת חדשה מ-550₪ כולל התקנה. חייגו 050-8307269 עכשיו."],
 "manulan-herum":["מנעולן חירום ב{A} 24/7. ניב מגיע תוך {E} בכל שעה, פותח בלי נזק ומחיר סגור בטלפון מ-350₪. חייגו 050-8307269.",
 "נתקעתם בחוץ ב{A} באמצע הלילה? מנעולן חירום אמיתי, בלי מוקד, הגעה תוך {E} ומחיר מראש. חייגו 050-8307269.",
 "מנעולן חירום ב{A} שעונה בעצמו. זמין יום ולילה, גם בשבתות וחגים, מ-350₪ סגור בשיחה. ניב 050-8307269."]}
